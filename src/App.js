	...
	return (
		<Router basename={process.env.REACT_APP_ROUTER_BASE_NAME}>
			...
			<Route
				exact
				path='/user/info'
				render={(props) => <UserInformation {...props} user={user} />}
			/>

			<Route
				exact
				path='/user/posts'
				render={(props) => <UserPosts {...props} user={user} />}
			/>
			<Route
				exact
				path='/user/todos'
				render={(props) => <UserTodos {...props} user={user} />}
			/>
			<Route exact path='/user/albums' render={(props) => <UserAlbums user={user} />} />

			<Route exact path='/posts' render={(props) => <AllPosts />} />
