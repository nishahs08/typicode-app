...
export const Photos = ({ user, albumId }) => {
    ...
    return (
        <>
            {photos.length > 0
                ?
                <ImageList variant="masonry" cols={6} gap={4} sx={{ maxHeight: 200 ,padding:'10px'}}>
               ...
               { Array(10).fill(0).map((item,i) =><Grid item key={i}> <Skeleton variant='rectangular' width={200} height={100} /></Grid>)}
                </Grid> 
            }
        </>
    )
